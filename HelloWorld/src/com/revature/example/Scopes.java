...
public class Scopes {
	 ...
	 * class
	 * should reference it as Scopes.variable1
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(s.variable2); // variable 2 is defined for the INSTANCE of the class
	...
	public void myMethod(String variable3) {
		...
		// i is only defined for the for loop! block scope, this would not work
		// System.out.println("value of i is: " + i);
